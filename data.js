...
const categories = ['Cà Phê', 'Trà & Trái Cây', 'Cacao & Matcha', 'Soda & Sữa Chua'];
...
function taoTheSanPham(coffee) {
    return `
        <div class="bg-white rounded-2xl shadow-sm border border-coffee-100 overflow-hidden hover:shadow-xl transition-shadow duration-300 group cursor-pointer" onclick="window.location.href='detail.html?id=${coffee.id}'">
